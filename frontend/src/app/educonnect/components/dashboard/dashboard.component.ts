...
export class DashboardComponent implements OnInit {
    ...
    // this is to delete the student from the Student - login
    deleteStudent(): void {
    ...
    // this is to delete the student from the Teacher - login where num refers to the id of the student that is being deleted.
    deleteStudentById(num : number): void {
        if (confirm('Are you sure you want to delete your student profile?')) {
            this.educonnectService.deleteStudent(num).subscribe({
                next: () => {
                    // this.router.navigate(['/']);
